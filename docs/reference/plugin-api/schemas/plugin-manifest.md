...
# PluginManifestLite
Cold-path hapi.plugin.json contract. Read before plugin code is imported.
Group: **Manifest**
JSON Schema: [PluginManifestLite](/docs/plugin-api/schemas/plugin-manifest.schema.json)
## Top-level fields
