export default {
  ...
  'settings.plugins.install.previewPlan': 'Preview plan',
  ...
  'settings.plugins.install.overwriteExisting': 'Overwrite',
  ...
  'settings.plugins.install.planTitle': 'Install plan',
  'settings.plugins.install.planReady': 'Install plan ready',
  'settings.plugins.install.planBlocked': 'Install plan blocked',
  ...
  'settings.plugins.detail.featureIntro.capabilities': 'Capabilities',
  'settings.plugins.capabilities.title': 'Capabilities',
