export default {
  ...
  'settings.plugins.empty.description': 'Install a trusted plugin from a Hub-local directory, then reload.',
  ...
  'settings.plugins.install.browserDescription': 'Browse directories on the HAPI Hub machine and select the plugin root.',
  'settings.plugins.install.openPath': 'Open path',
  'settings.plugins.install.parent': 'Parent directory',
  'settings.plugins.install.useThisFolder': 'Use this folder',
  'settings.plugins.install.loadingDirectory': 'Loading directory…',
  'settings.plugins.install.noEntries': 'No entries in this directory.',
  'settings.plugins.install.browseFailed': 'Failed to list directory.',
  'settings.plugins.install.manifestFound': 'Manifest found',
  'settings.plugins.install.manifestMissing': 'No manifest here',
  'settings.plugins.install.pluginFolder': 'plugin',
  'settings.plugins.install.installLocal': 'Install local plugin',
  'settings.plugins.install.enableAfterInstall': 'Enable after install',
  'settings.plugins.install.overwriteExisting': 'Overwrite existing',
  'settings.plugins.install.pathRequired': 'Enter a Hub-local plugin directory path.',
  ...
  'settings.plugins.detail.actionsDescription': 'Enable, disable, or reload this plugin in the Hub runtime.',
  ...
  'settings.plugins.detail.runtimeDescription': 'Hub runtime entry and resolved file paths.',
  ...
  'settings.plugins.detail.contributions': 'Contributions',
  'settings.plugins.detail.noContributions': 'No Hub contributions declared.',
  'settings.plugins.detail.permissions': 'Permissions',
  'settings.plugins.detail.permissionsDescription': 'Declarations for review. They do not sandbox plugin code.',
  ...
  'settings.plugins.config.title': 'Config JSON',
  'settings.plugins.config.description': 'Edit plugin config as a JSON object. Secret values should stay in environment variables.',
  'settings.plugins.config.textareaLabel': 'Plugin config JSON',
  ...
  'settings.plugins.confirm.enable': 'This plugin will run as trusted local code inside the HAPI Hub process. Permissions are declarations for review, not sandbox enforcement. Secret values are never displayed or stored by Web. Enable plugin?',
  'settings.plugins.confirm.enable.title': 'Enable plugin?',
  'settings.plugins.confirm.enable.description': 'This plugin will run as trusted local code inside the HAPI Hub process. Permissions are declarations for review, not sandbox enforcement. Secret values are never displayed or stored by Web.',
