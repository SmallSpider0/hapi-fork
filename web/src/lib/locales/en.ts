export default {
  ...
  'settings.plugins.marketplace.trustWarning': 'Marketplace plugins run as trusted local Hub/Runner code. Install only plugins and repositories you trust.',
  ...
  'settings.plugins.marketplace.packageDetails': 'Package',
