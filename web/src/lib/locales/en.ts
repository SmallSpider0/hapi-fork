export default {
  ...
  'settings.plugins.empty.description': 'Install the example plugin or add a local plugin directory, then reload.',
  ...
  'settings.plugins.install.description': 'Install a built-in example or copy a plugin from a Hub-local filesystem path.',
  'settings.plugins.install.example': 'Install example plugin',
  'settings.plugins.install.exampleDescription': 'Adds and enables a local notification logger for development/testing.',
