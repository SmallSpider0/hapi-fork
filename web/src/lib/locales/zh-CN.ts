export default {
  ...
  'settings.plugins.empty.description': '从 Hub 本地目录安装可信插件，然后重载。',
  ...
  'settings.plugins.install.browserDescription': '浏览 HAPI Hub 机器上的目录，并选择插件根目录。',
  'settings.plugins.install.openPath': '打开路径',
  'settings.plugins.install.parent': '上级目录',
  'settings.plugins.install.useThisFolder': '使用此目录',
  'settings.plugins.install.loadingDirectory': '正在加载目录…',
  'settings.plugins.install.noEntries': '此目录为空。',
  'settings.plugins.install.browseFailed': '目录加载失败。',
  'settings.plugins.install.manifestFound': '已找到 Manifest',
  'settings.plugins.install.manifestMissing': '此处没有 Manifest',
  'settings.plugins.install.pluginFolder': '插件',
  'settings.plugins.install.installLocal': '安装本地插件',
  'settings.plugins.install.enableAfterInstall': '安装后启用',
  'settings.plugins.install.overwriteExisting': '覆盖已存在插件',
  'settings.plugins.install.pathRequired': '请输入 Hub 本地插件目录路径。',
  ...
  'settings.plugins.detail.actionsDescription': '在 Hub runtime 中启用、禁用或重载该插件。',
  ...
  'settings.plugins.detail.runtimeDescription': 'Hub runtime 入口及解析后的文件路径。',
  ...
  'settings.plugins.detail.contributions': '贡献项',
  'settings.plugins.detail.noContributions': '未声明 Hub 贡献项。',
  'settings.plugins.detail.permissions': '权限',
  'settings.plugins.detail.permissionsDescription': '用于审阅的声明，不会沙箱化插件代码。',
  ...
  'settings.plugins.config.description': '以 JSON object 形式编辑插件配置。Secret value 应保留在环境变量中。',
  'settings.plugins.config.textareaLabel': '插件 Config JSON',
  ...
  'settings.plugins.config.mustBeObject': 'Config 必须是 JSON object。',
  'settings.plugins.config.invalidJson': 'JSON 无效',
  'settings.plugins.config.redactedPlaceholder': 'Config 在 {path} 包含已脱敏占位符。保存前请替换为真实值，或删除该字段。',
  'settings.plugins.diagnostics.title': '诊断',
  'settings.plugins.diagnostics.empty': '无诊断。',
  'settings.plugins.confirm.enable': '该插件会作为受信任的本地代码在 HAPI Hub 进程内运行。Permissions 只是声明与审计，不是沙箱强制边界。Web 不会显示或保存 secret value。确认启用插件？',
  'settings.plugins.confirm.enable.title': '启用插件？',
  'settings.plugins.confirm.enable.description': '该插件会作为受信任的本地代码在 HAPI Hub 进程内运行。Permissions 只是声明与审阅，不是沙箱强制边界。Web 不会显示或保存 secret value。',
