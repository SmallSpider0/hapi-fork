export default {
  ...
  'settings.plugins.empty.description': '安装示例插件，或添加一个本地插件目录后重载。',
  ...
  'settings.plugins.install.description': '安装内置示例插件，或从 Hub 所在机器的本地路径复制插件。',
  'settings.plugins.install.example': '安装示例插件',
  'settings.plugins.install.exampleDescription': '添加并启用用于开发/测试的本地通知日志插件。',
