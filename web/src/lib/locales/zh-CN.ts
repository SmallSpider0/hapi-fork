export default {
  ...
  'settings.plugins.install.previewPlan': '预检',
  ...
  'settings.plugins.install.overwriteExisting': '覆盖',
  ...
  'settings.plugins.install.planTitle': '安装计划',
  'settings.plugins.install.planReady': '安装计划已就绪',
  'settings.plugins.install.planBlocked': '安装计划被阻止',
  ...
  'settings.plugins.capabilities.title': '能力',
  ...
  'settings.plugins.detail.permissionsDescription': '',
  ...
  'settings.plugins.confirm.enable.description': '该插件会作为受信任代码在 {target} 中运行。权限只是声明，不是沙箱强制边界。Web 不会显示或保存 secret value。',
  ...
  'settings.plugins.descriptor.invalidComponent': 'Descriptor 组件无效。',
  'settings.plugins.descriptor.unsupportedAction': '不支持的操作 descriptor。',
  'settings.plugins.descriptor.invalidPanel': '插件设置面板 descriptor 校验失败。',
  'settings.plugins.descriptor.panelRenderFailed': '插件设置面板渲染失败。',
  'settings.plugins.descriptor.componentValidationFailed': '插件 descriptor 组件校验失败。',
